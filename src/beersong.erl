%% @author vinod
%% @doc @todo Add description to beersong.
...
phrase(0) ->
	["No more bottles", "no more bottles"];

phrase(1) ->
	["1 bottle", "1 bottle", "no more bottles"];
...
sing_verse(Bottle) ->
	...
	after
	3000 ->
		io:format("Verse not received after 3 secodns"
